...
bakery_name= {1:"카스테라",2:"크로플",3:"바움쿠엔"}
...
while True:
    ...
    if choice ==1: #음료
        ...
        price_save.append(drink_name[sub])
    elif choice ==2: #빵
        print("▲△ 1.빵(Bakery) 메뉴")
        ...
        price_save.append(bakery_name[sub])
    elif choice ==3: #굿즈
        print("▲△ 3.굿즈(Goods) 메뉴")
        ...
        price_save.append(goods_name[sub])
    elif choice ==99:
    ...
    if flag ==1:
        ...
        for price in price_save:
            total_price += price
        print(f"고객님이 주문하신 메뉴는 {len(menu_save)}개로")
        print(f"총 결제금액은 {total_price}원 입니다.")
